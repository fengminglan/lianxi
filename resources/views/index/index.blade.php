            ...
            <div class="row">
                ...
                <div class="col-md-10 pull-right">
                    <ul class="header-navigation">
                        <li class="current"><a href="#promo-block">网站首页</a></li>
                        <li><a href="#about">关于我们</a></li>
                        <li><a href="#services">工程业绩</a></li>
                        <li><a href="#team">新闻中心</a></li>
                        <li><a href="#portfolio">企业文化</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="copyright">2014 © Metronic One Page.KeenThemes  ALL Rights Reserved.</div>
                </div>
                <!-- END COPYRIGHT -->
                <!-- BEGIN SOCIAL ICONS -->
                <div class="col-md-4 col-sm-4">
                ...
                <div class="col-md-4 col-sm-4 text-right">
                    <p class="powered">More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
                </div>
                <!-- END COPYRIGHT -->
            </div>
        </div>
